        ...
        <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <li><a class="dropdown-item" href="{{request()->url()}}?language={{$locale}}">{{$locale}}</a></li>
                    @endforeach
...
{{--                </div>--}}
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2020 <a href="https://adminlte.io">Ios</a>.</strong>
        All rights reserved.
...
<script src="https://cdn.tiny.cloud/1/c94l9jukin9825lratd30wembsnk0yqakeaikeorgfw74g81/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
